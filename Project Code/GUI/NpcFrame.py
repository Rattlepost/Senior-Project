...
class NpcFrame(ctk.CTkFrame):
    ...
    def create_widgets(self):  # Create buttons, labels, and dropdown menus
        ...
        # NPC attributes
        self.health_label = ctk.CTkLabel(self.info_frame, text='Health Points: ', anchor='w')
        ...
        self.alignment_label = ctk.CTkLabel(self.info_frame, text='Alignment: ', anchor='w')
        ...
        self.info_textbox = ctk.CTkTextbox(self, width=400, height=300, wrap="word", font=("Arial", 14))
