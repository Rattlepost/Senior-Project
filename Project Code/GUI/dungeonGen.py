...
def generate_dungeon(num_rooms): # Function to generate a dungeon with a given number of rooms
    ...
    for room_id in range(2, num_rooms + 1): # Loop to create rooms
        while True:
            ...
            if -3 < new_position[0] < 3 and -3 < new_position[1] < 3: # Check if the new position is within bounds of canvas
